# 1 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino"
// =============================
...
# 9 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 2
# 10 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 2
# 11 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 2
...
void __attribute__((section(".iram1" "." "28"))) isrEncA_1()
{
  vPortEnterCritical(&encoderMux);
  bool b = digitalRead(digitalPinToGPIONumber(ENCB_1));
  enc1_count += b ? +1 : -1;
  vPortExitCritical(&encoderMux);
}

void __attribute__((section(".iram1" "." "29"))) isrEncB_1()
{
  vPortEnterCritical(&encoderMux);
  bool a = digitalRead(digitalPinToGPIONumber(ENCA_1));
  enc1_count += a ? -1 : +1;
  vPortExitCritical(&encoderMux);
}

void __attribute__((section(".iram1" "." "30"))) isrEncA_2()
{
  vPortEnterCritical(&encoderMux);
  bool b = digitalRead(digitalPinToGPIONumber(ENCB_2));
  enc2_count += b ? +1 : -1;
  vPortExitCritical(&encoderMux);
}

void __attribute__((section(".iram1" "." "31"))) isrEncB_2()
{
  vPortEnterCritical(&encoderMux);
  bool a = digitalRead(digitalPinToGPIONumber(ENCA_2));
  enc2_count += a ? -1 : +1;
  vPortExitCritical(&encoderMux);
}
...
int32_t lastReportedPosition1Counts = 
# 127 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 3 4
                                     (-0x7fffffff - 1)
# 127 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino"
                                              ;
int32_t lastReportedPosition2Counts = 
# 128 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 3 4
                                     (-0x7fffffff - 1)
# 128 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino"
                                              ;
...
void setup()
{
  ...
  pinMode(digitalPinToGPIONumber(ENCA_1), 0x05);
  pinMode(digitalPinToGPIONumber(ENCB_1), 0x05);
  pinMode(digitalPinToGPIONumber(ENCA_2), 0x05);
  pinMode(digitalPinToGPIONumber(ENCB_2), 0x05);

  attachInterrupt(digitalPinToGPIONumber(((((uint8_t)digitalPinToGPIONumber(ENCA_1))<(49) /* All GPIOs*/)?(ENCA_1):-1)), isrEncA_1, 0x01)


             ;
  attachInterrupt(digitalPinToGPIONumber(((((uint8_t)digitalPinToGPIONumber(ENCB_1))<(49) /* All GPIOs*/)?(ENCB_1):-1)), isrEncB_1, 0x01)


             ;
  attachInterrupt(digitalPinToGPIONumber(((((uint8_t)digitalPinToGPIONumber(ENCA_2))<(49) /* All GPIOs*/)?(ENCA_2):-1)), isrEncA_2, 0x01)


             ;
  attachInterrupt(digitalPinToGPIONumber(((((uint8_t)digitalPinToGPIONumber(ENCB_2))<(49) /* All GPIOs*/)?(ENCB_2):-1)), isrEncB_2, 0x01)
...
void loop()
{
  ...
  while (BLE_hasNewCommand())
  {
    ...
    case START_MOTOR:
      lastReportedPosition1Counts = 
# 214 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 3 4
                                   (-0x7fffffff - 1)
# 214 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino"
                                            ;
      lastReportedPosition2Counts = 
# 215 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino" 3 4
                                   (-0x7fffffff - 1)
# 215 "C:\\Users\\Josia\\OneDrive\\Documents\\SeniorDesignPrototype\\FunctionalPrototype\\FunctionalPrototype.ino"
                                            ;
